...
extension AccountSummaryCell {
    private func setup() {
        ...
        shevronImageView.image = chevronImage
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            shevronImageView.topAnchor.constraint(equalToSystemSpacingBelow: underlineView.bottomAnchor, multiplier: 1),
            trailingAnchor.constraint(equalToSystemSpacingAfter: shevronImageView.trailingAnchor, multiplier: 1)
        ])
    }
